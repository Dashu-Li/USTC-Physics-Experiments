...
$N$ (10 s) & 89737 & 89737 & 89737 & 89738 & 89737 & 89737 & 89737 \\
\bottomrule
\end{tabular}
\end{center}
...
\begin{axis}[
    ...
    ylabel={计数 $N$（10 s）},
    xmin=3.35, xmax=5.35,
    ymin=89736.7, ymax=89738.3,
    grid=both,
    minor tick num=1,
    mark size=1.8pt
]
\addplot[only marks, color=blue] coordinates {
(3.4,89738) (3.5,89738) (3.6,89738) (3.7,89738) (3.8,89738)
(3.9,89738) (4.0,89737) (4.1,89737) (4.2,89737) (4.3,89737)
(4.4,89737) (4.5,89737) (4.6,89737) (4.7,89737) (4.8,89737)
(4.9,89737) (5.0,89738) (5.1,89737) (5.2,89737) (5.3,89737)
};
\addplot[domain=3.35:5.35, samples=2, color=red, dashed] {89737.35};
\legend{实测点, 平台平均线}
\end{axis}
\end{tikzpicture}
\caption{第一组标准信号测量结果（平台区示意）}\label{fig:group1-platform}
\end{figure}

说明：原始表格中的 $t=\SI{3.3}{\micro\second},\,N=0$ 已完整保留；由于该点与平台区计数量级差异过大，图~\ref{fig:group1-platform} 仅展示平台区数据以便观察细节。
...
\begin{axis}[
    ...
    symbolic x coords={III符合,IIbeta,Igamma},
    xtick=data,
    ymin=0,
    grid=both,
    minor tick num=1,
...
\addplot coordinates {(III符合,1.2933) (IIbeta,29.5067) (Igamma,388.6567)};
\addplot coordinates {(III符合,0.4467) (IIbeta,8.7667) (Igamma,401.0400)};
\addplot coordinates {(III符合,0.0267) (IIbeta,4.9333) (Igamma,171.5633)};
